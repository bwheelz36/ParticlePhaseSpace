...
Software similar to this has been used in many publications previously, however this software has not been open sourced. One notable exception to this is the code `p2sat` @lesnat_particle_2021; while this code shares many of the goals and features of ParticlePhaseSpace, it lacks a test framework and automated documentation building; it unfortunately also does not appear to be actively maintained. As such, the authors believe that ParticlePhaseSpace is the first open source code including automated testing and documentation for the import, analysis, and export of phase space data
